...
pub fn new_session_name(name_kind: NameKind, desired_name: Option<String>, exists: &dyn Fn(String) -> bool) -> String {
...
fn random_animal() -> String {
  ...
  format!("{}-{}", SHORT_ADJECTIVES[adjective_index], ANIMALS[animal_index])
}
